...
let ChannelsController = class ChannelsController {
    ...
    async create(req, data) {
        console.log(...oo_oo(`303414230_17_4_17_101_4`, "-------------------------- Starting Creating a Channel -------------------------- "));
        try {
            ...
            if (user) {
                ...
                console.log(...oo_oo(`303414230_25_8_25_28_4`, channel));
            }
            return (true);
        }
        catch (error) {
            console.log(...oo_oo(`303414230_29_6_29_32_4`, error.message));
    ...
    async updatePass(req, data) {
        try {
            ...
            console.log(...oo_oo(`303414230_84_6_84_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async removePass(req, data) {
        try {
            ...
            console.log(...oo_oo(`303414230_102_6_102_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async setPass(req, data) {
        console.log(...oo_oo(`303414230_110_4_110_87_4`, "-------------------------- SET PASSWORD  -------------------------- "));
        console.log(...oo_oo(`303414230_111_4_111_21_4`, data));
        try {
            const decode = this.jwt.verify(req.cookies['cookie']);
            const user = await this.UsersService.findById(decode.id);
            if (user) {
            ...
            console.log(...oo_oo(`303414230_122_6_122_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async setAdmin(req, data) {
        console.log(...oo_oo(`303414230_129_4_129_84_4`, "-------------------------- SET ADMIN  -------------------------- "));
        console.log(...oo_oo(`303414230_130_4_130_21_4`, data));
        try {
            await this.channelsService.setAdmin(data);
            return (true);
        }
        catch (error) {
            console.log(...oo_oo(`303414230_136_6_136_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async removeChannel(req, data) {
        console.log(...oo_oo(`303414230_144_4_144_84_4`, "-------------------------- SET ADMIN  -------------------------- "));
        console.log(...oo_oo(`303414230_145_4_145_21_4`, data));
        try {
            ...
            console.log(...oo_oo(`303414230_154_6_154_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getPublicChannels() {
        try {
            ...
            console.log(...oo_oo(`303414230_164_6_164_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getProtectedChannels() {
        try {
            ...
            console.log(...oo_oo(`303414230_174_6_174_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getAllChannels(req, data) {
        try {
            ...
            console.log(...oo_oo(`303414230_220_6_220_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
};
