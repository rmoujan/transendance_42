...
let ChannelsController = class ChannelsController {
    ...
    async create(req, data) {
        console.log(...oo_oo(`1509061124_22_4_22_101_4`, "-------------------------- Starting Creating a Channel -------------------------- "));
        console.log(...oo_oo(`1509061124_23_4_23_21_4`, data));
        if (data) {
        ...
        try {
            ...
            if (user) {
                ...
                console.log(...oo_oo(`1509061124_47_8_47_28_4`, channel));
                if (channel)
                    return (true);
                else
                    return false;
    ...
    async join(req, data) {
        console.log(...oo_oo(`1509061124_61_4_61_101_4`, "-------------------------- Starting Joining a Channel  -------------------------- "));
        console.log(...oo_oo(`1509061124_62_4_62_21_4`, data));
        if (data) {
        ...
        try {
            ...
            if (user) {
                ...
                if (memberChannel) {
                    console.log(...oo_oo(`1509061124_94_10_94_60_4`, "operation accomplished successfully"));
                    return (true);
                }
                else {
                    console.log(...oo_oo(`1509061124_99_10_99_69_4`, "operation does not accomplished successfully"));
                    return (false);
                }
            }
            else
    ...
    async updatePass(req, data) {
        console.log(...oo_oo(`1509061124_116_4_116_90_4`, "-------------------------- UPDATE PASSWORD  -------------------------- "));
        console.log(...oo_oo(`1509061124_117_4_117_21_4`, data));
        if (data) {
        ...
        try {
            ...
            console.log(...oo_oo(`1509061124_141_6_141_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async removePass(req, data) {
        console.log(...oo_oo(`1509061124_148_4_148_90_4`, "-------------------------- REMOVE PASSWORD  -------------------------- "));
        console.log(...oo_oo(`1509061124_149_4_149_21_4`, data));
        if (data) {
    ...
    async setPass(req, data) {
        console.log(...oo_oo(`1509061124_180_4_180_87_4`, "-------------------------- SET PASSWORD  -------------------------- "));
        console.log(...oo_oo(`1509061124_181_4_181_21_4`, data));
        if (data) {
            if (!data.password || !data.user_id || !data.channel_id) {
                console.log(...oo_oo(`1509061124_186_8_186_35_4`, "inside false"));
                return (false);
            }
        }
        else
        ...
        try {
            ...
            if (user) {
                ...
                if (setch) {
                    console.log(...oo_oo(`1509061124_200_10_200_43_4`, "set ch true", setch));
                    return (true);
                }
                else
                    return (false);
    ...
    async setAdmin(req, data) {
        console.log(...oo_oo(`1509061124_216_4_216_84_4`, "-------------------------- SET ADMIN  -------------------------- "));
        console.log(...oo_oo(`1509061124_217_4_217_21_4`, data));
        if (data) {
            if (!data.to || !data.channel_id || !data.from) {
                console.log(...oo_oo(`1509061124_222_8_222_35_4`, "inside false"));
                return (false);
            }
        }
        else
        ...
        try {
            ...
            console.log(...oo_oo(`1509061124_236_6_236_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async removeChannel(req, data) {
        console.log(...oo_oo(`1509061124_244_4_244_89_4`, "-------------------------- Remove Channel  -------------------------- "));
        console.log(...oo_oo(`1509061124_245_4_245_21_4`, data));
        if (data) {
            if (!data.user_id || !data.channel_id) {
                console.log(...oo_oo(`1509061124_251_8_251_35_4`, "inside false"));
                return (false);
            }
        }
        else
        ...
        try {
            ...
            console.log(...oo_oo(`1509061124_267_6_267_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getPublicChannels() {
        try {
            ...
            console.log(...oo_oo(`1509061124_277_6_277_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getProtectedChannels() {
        try {
            ...
            console.log(...oo_oo(`1509061124_287_6_287_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getPrivateChannels() {
        try {
            ...
            console.log(...oo_oo(`1509061124_297_6_297_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getAllChannels(req, data) {
        console.log(...oo_oo(`1509061124_305_4_305_110_4`, "-------------------------- all channels that a user inside them -------------------------- "));
        try {
            const decode = this.jwt.verify(req.cookies[this.config.get('cookie')]);
            const user = await this.UsersService.findById(decode.id);
