...
let ChannelsController = class ChannelsController {
    ...
    async create(req, data) {
        console.log(...oo_oo(`895446723_22_4_22_101_4`, "-------------------------- Starting Creating a Channel -------------------------- "));
        console.log(...oo_oo(`895446723_23_4_23_21_4`, data));
        if (data) {
        ...
        try {
            ...
            if (user) {
                ...
                console.log(...oo_oo(`895446723_47_8_47_28_4`, channel));
                if (channel)
                    return (true);
                else
                    return false;
    ...
    async join(req, data) {
        console.log(...oo_oo(`895446723_60_4_60_101_4`, "-------------------------- Starting Joining a Channel  -------------------------- "));
        console.log(...oo_oo(`895446723_61_4_61_21_4`, data));
        if (data) {
        ...
        try {
            ...
            if (user) {
                ...
                if (memberChannel) {
                    console.log(...oo_oo(`895446723_93_10_93_60_4`, "operation accomplished successfully"));
                    return (true);
                }
                else {
                    console.log(...oo_oo(`895446723_98_10_98_69_4`, "operation does not accomplished successfully"));
                    return (false);
                }
            }
            else
    ...
    async updatePass(req, data) {
        console.log(...oo_oo(`895446723_115_4_115_90_4`, "-------------------------- UPDATE PASSWORD  -------------------------- "));
        console.log(...oo_oo(`895446723_116_4_116_21_4`, data));
        if (data) {
        ...
        try {
            ...
            console.log(...oo_oo(`895446723_140_6_140_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async removePass(req, data) {
        console.log(...oo_oo(`895446723_147_4_147_90_4`, "-------------------------- REMOVE PASSWORD  -------------------------- "));
        console.log(...oo_oo(`895446723_148_4_148_21_4`, data));
        if (data) {
    ...
    async setPass(req, data) {
        console.log(...oo_oo(`895446723_179_4_179_87_4`, "-------------------------- SET PASSWORD  -------------------------- "));
        console.log(...oo_oo(`895446723_180_4_180_21_4`, data));
        if (data) {
            if (!data.password || !data.user_id || !data.channel_id) {
                console.log(...oo_oo(`895446723_185_8_185_35_4`, "inside false"));
                return (false);
            }
        }
        else
        ...
        try {
            ...
            if (user) {
                ...
                if (setch) {
                    console.log(...oo_oo(`895446723_199_10_199_43_4`, "set ch true", setch));
                    return (true);
                }
                else
                    return (false);
    ...
    async setAdmin(req, data) {
        console.log(...oo_oo(`895446723_215_4_215_84_4`, "-------------------------- SET ADMIN  -------------------------- "));
        console.log(...oo_oo(`895446723_216_4_216_21_4`, data));
        if (data) {
            if (!data.to || !data.channel_id || !data.from) {
                console.log(...oo_oo(`895446723_221_8_221_35_4`, "inside false"));
                return (false);
            }
        }
        else
        ...
        try {
            ...
            console.log(...oo_oo(`895446723_235_6_235_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async removeChannel(req, data) {
        console.log(...oo_oo(`895446723_243_4_243_89_4`, "-------------------------- Remove Channel  -------------------------- "));
        console.log(...oo_oo(`895446723_244_4_244_21_4`, data));
        if (data) {
            if (!data.user_id || !data.channel_id) {
                console.log(...oo_oo(`895446723_250_8_250_35_4`, "inside false"));
                return (false);
            }
        }
        else
        ...
        try {
            ...
            console.log(...oo_oo(`895446723_266_6_266_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getPublicChannels() {
        try {
            ...
            console.log(...oo_oo(`895446723_276_6_276_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getProtectedChannels() {
        try {
            ...
            console.log(...oo_oo(`895446723_286_6_286_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getPrivateChannels() {
        try {
            ...
            console.log(...oo_oo(`895446723_296_6_296_32_4`, error.message));
            return { message: 'An error occurred', error: error.message };
        }
    }
    async getAllChannels(req, data) {
        console.log(...oo_oo(`895446723_304_4_304_110_4`, "-------------------------- all channels that a user inside them -------------------------- "));
        try {
            const decode = this.jwt.verify(req.cookies[this.config.get('cookie')]);
            const user = await this.UsersService.findById(decode.id);
