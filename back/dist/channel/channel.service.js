...
let ChannelsService = class ChannelsService {
    ...
    async getPrivateChannels() {
        try {
            ...
            throw new common_1.NotFoundException(`we have no private channels`);
        }
    }
    ...
    async joinChannel(data, usid) {
        try {
            ...
            if (ch) {
                console.log(...oo_oo(`3359706954_170_8_170_23_4`, ch));
                console.log(...oo_oo(`3359706954_171_8_171_52_4`, "¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤ 1"));
                if (ch.visibility === "protected") {
                    console.log(...oo_oo(`3359706954_174_10_174_54_4`, "¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤ 2"));
                ...
                if (join == 1 || ch.visibility === "public") {
                    console.log(...oo_oo(`3359706954_183_12_183_56_4`, "¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤ 3"));
                    const memberchannel = await this.prisma.memberChannel.create({
                        data: {
                            userId: usid,
                            channelId: ch.id_channel,
                    ...
                    console.log(...oo_oo(`3359706954_192_16_192_62_4`, "############### AFTER JOINGING "));
                    return true;
                }
            }
        }
        catch (error) {
            console.log(...oo_oo(`3359706954_198_6_198_50_4`, "ERRRRRRRRRRRRROR JOIN CHANNEL"));
                ...
                if (record && record2) {
                    if (record.status_UserInChannel === "owner" || record.status_UserInChannel === "admin") {
                        if (record2.status_UserInChannel !== "owner" && record2.status_UserInChannel !== "admin") {
                            ...
                            console.log(...oo_oo(`3359706954_504_10_504_65_4`, `AFTER KICKING THIS USER ${updateChannel}`));
                            return updateChannel;
                        }
                        else {
