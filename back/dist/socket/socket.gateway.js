...
let SocketGateway = class SocketGateway {
    ...
    decodeCookie(client) {
        ...
        if (cookieHeader == undefined)
            return null;
        console.log(...oo_oo(`7266669_36_4_36_29_4`, cookieHeader));
    ...
    async handleUserOffline(client) {
        console.log(...oo_oo(`7266669_107_4_107_30_4`, "offliiiiine"));
        const decoded = this.decodeCookie(client);
        if (decoded == null)
            return;
        await this.prisma.user.update({
    ...
    handleMessage(body) {
        console.log(...oo_oo(`7266669_124_4_124_21_4`, body));
        return "Hello world!";
    }
    async invite_game(client, body) {
        const decoded = this.decodeCookie(client);
        console.log(...oo_oo(`7266669_131_4_131_37_4`, "inviiiiite to play"));
        const data = await this.prisma.user.findUnique({
            where: { id_user: decoded.id },
        });
        console.log(...oo_oo(`7266669_135_4_135_40_4`, "in game ", data.InGame));
        ...
        if (notify == null) {
            if (data.InGame == false) {
                ...
                console.log(...oo_oo(`7266669_156_8_156_38_4`, "bodyyyyy ", body));
                const sock = this.SocketContainer.get(body.id_user);
                console.log(...oo_oo(`7266669_158_8_158_36_4`, "sooock ", sock));
    ...
    async NewFriend(client, body) {
        console.log(...oo_oo(`7266669_202_4_202_21_4`, body));
        const decoded = this.decodeCookie(client);
        const sockrecv = this.SocketContainer.get(decoded.id);
        console.log(...oo_oo(`7266669_208_4_208_42_4`, "right bar gatway ", body));
    ...
    async friends_list(client, body) {
        const decoded = this.decodeCookie(client);
        console.log(...oo_oo(`7266669_217_4_217_40_4`, "friends list : ", body));
        const sockrecv = this.SocketContainer.get(decoded.id);
        const socksend = this.SocketContainer.get(body);
