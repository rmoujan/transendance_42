...
exports.CloudinaryModule = CloudinaryModule = __decorate([
    (0, common_1.Module)({
        providers: [cloudinary_controller_1.CloudinaryProvider, cloudinary_service_1.CloudinaryService],
        exports: [cloudinary_controller_1.CloudinaryProvider, cloudinary_service_1.CloudinaryService],
    })
], CloudinaryModule);
