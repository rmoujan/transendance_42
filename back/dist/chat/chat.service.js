...
let ChatService = class ChatService {
    ...
    async getAllConversations(id) {
        try {
            ...
            console.log(...oo_oo(`3425608181_115_6_115_61_4`, `!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  :: ${dms}`));
            return dms;
        }
        catch (error) {
    ...
    async getDm(idSend, idRecv) {
        try {
            ...
            if (dm1) {
                console.log(...oo_oo(`3425608181_137_8_137_39_4`, `get Dm1 |${dm1}|`));
                return dm1;
            }
            const dm2 = await this.prisma.dm.findUnique({
                where: {
            ...
            if (dm2) {
                console.log(...oo_oo(`3425608181_150_8_150_39_4`, `get dm2 |${dm2}|`));
                return dm2;
            }
        }
        catch (error) {
    ...
    async getLeavingRoom(idUs, idch) {
        try {
            ...
            if (record) {
                console.log(...oo_oo(`3425608181_246_8_246_39_4`, "DELETING USER \n"));
