...
let ChatService = class ChatService {
    ...
    async checkDm(idSend, idRecv) {
        ...
        if (dm1) {
            console.log(...oo_oo(`3579975717_47_6_47_38_4`, `FRom dm1 |${dm1}|`));
            return dm1;
        }
        ...
        if (dm2) {
            console.log(...oo_oo(`3579975717_60_6_60_38_4`, `FRom dm2 |${dm2}|`));
            return dm2;
        }
        ...
        console.log(...oo_oo(`3579975717_72_4_72_78_4`, "CHECK DM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%   %%%%%%%%%%%%"));
        console.log(...oo_oo(`3579975717_73_4_73_38_4`, `Result is ${result}`));
        return (result);
    }
    ...
    async getAllConversations(id) {
        try {
            ...
            console.log(...oo_oo(`3579975717_119_6_119_61_4`, `!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  :: ${dms}`));
            return dms;
        }
        catch (error) {
    ...
    async getDm(idSend, idRecv) {
        try {
            ...
            if (dm1) {
                console.log(...oo_oo(`3579975717_141_8_141_39_4`, `get Dm1 |${dm1}|`));
                return dm1;
            }
            const dm2 = await this.prisma.dm.findUnique({
                where: {
            ...
            if (dm2) {
                console.log(...oo_oo(`3579975717_154_8_154_39_4`, `get dm2 |${dm2}|`));
                return dm2;
            }
        }
        catch (error) {
    ...
    async getLeavingRoom(idUs, idch) {
        try {
            ...
            if (record) {
                console.log(...oo_oo(`3579975717_247_8_247_39_4`, "DELETING USER \n"));
