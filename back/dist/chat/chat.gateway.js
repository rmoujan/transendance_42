...
let ChatGateway = class ChatGateway {
    ...
    decodeCookie(client) {
        ...
        if (cookieHeader == undefined)
            return null;
        console.log(...oo_oo(`271497111_47_4_47_29_4`, cookieHeader));
    ...
    handleConnection(client) {
        ...
        console.log(...oo_oo(`271497111_69_4_69_48_4`, client.handshake.query?.user_id));
        this.logger.log(` ********  User  Connected : ${decoded.id} and its sockets is ${client.id}`);
        this.connectedClients.set(decoded.id, client);
        console.log(...oo_oo(`271497111_79_4_79_77_4`, "####### First connection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`271497111_81_6_81_49_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    handleDisconnect(client) {
        ...
        console.log(...oo_oo(`271497111_93_4_93_79_4`, "***** Client Disconnection :: OUTPUT MAP OF CONNECTE CLIENTS"));
        for (const [key, value] of this.connectedClients) {
            console.log(...oo_oo(`271497111_95_6_95_49_4`, `Key: ${key}, Value: ${value}`));
        }
    }
    createRoom(senderId, recieverId) {
        console.log(...oo_oo(`271497111_106_4_106_101_4`, `From Create Room Server Side : sender is ${senderId} and reciever is ${recieverId}`));
        const roomName1 = `room_${senderId}_${recieverId}`;
        const roomName2 = `room_${recieverId}_${senderId}`;
        console.log(...oo_oo(`271497111_110_4_110_74_4`, `roomName1 is ${roomName1} and roomName2 is ${roomName2}`));
        const check1 = this.roomsDm.indexOf(roomName1);
        const check2 = this.roomsDm.indexOf(roomName2);
        console.log(...oo_oo(`271497111_114_4_114_60_4`, `From create room server side after check `));
    ...
    async handling_joinRoom_dm(room, senderId, receiverId, message) {
        ...
        console.log(...oo_oo(`271497111_155_4_155_55_4`, "*************   handling_joinRoom_dm"));
        const result = await this.ChatService.cheakBlockedUser(senderId, receiverId);
        if (result) {
            console.log(...oo_oo(`271497111_159_6_159_52_4`, "u are blocked from the reciever"));
        }
        else {
            this.joinRoom(senderClient, room);
            this.joinRoom(receiverClient, room);
            console.log(...oo_oo(`271497111_166_6_166_37_4`, "starting sending"));
            console.log(...oo_oo(`271497111_168_6_168_27_4`, senderId));
            console.log(...oo_oo(`271497111_169_6_169_29_4`, receiverId));
            const dm = await this.ChatService.checkDm(senderId, receiverId);
            console.log(...oo_oo(`271497111_175_6_175_54_4`, `FROM gatways value of Dm is ${dm}`));
            console.log(...oo_oo(`271497111_177_6_177_72_4`, `^^^  SENDER IS ${senderId} REciver is ${receiverId}`));
            ...
            console.log(...oo_oo(`271497111_192_6_192_71_4`, `¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤¤`));
            this.server.to(room).emit('chatToDm', data);
        }
    }
    process_dm(client, data) {
        let room;
        console.log(...oo_oo(`271497111_209_4_209_49_4`, "*************   direct_message"));
    ...
    async handling_joinRoom_group(data, users) {
        console.log(...oo_oo(`271497111_232_4_232_58_4`, "*************   handling_joinRoom_group"));
        const room = `room_${data.id}`;
        for (const user of users) {
            console.log(...oo_oo(`271497111_239_6_239_45_4`, "Inside sockets of groups"));
            const client = this.connectedClients.get(user.userId);
            console.log(...oo_oo(`271497111_241_6_241_53_4`, "11111111111111111111111111111111"));
            this.joinRoom(client, room);
            console.log(...oo_oo(`271497111_243_6_243_59_4`, "22222222222222222222222222222222222222"));
        }
        ...
        if (checkmutedUser) {
            if (checkmutedUser.muted == false) {
                ...
                console.log(...oo_oo(`271497111_258_8_258_47_4`, "befoor emiting in groups"));
                this.server.to(room).emit('chatToGroup', result);
                console.log(...oo_oo(`271497111_260_8_260_40_4`, "ENDING JOINGROUP "));
            }
        }
    }
    async sendInChannel(client, data) {
        console.log(...oo_oo(`271497111_283_4_283_64_4`, "&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&"));
        console.log(...oo_oo(`271497111_284_4_284_50_4`, "*************   channel_message"));
        const channel = await this.ChatService.findChannel(data.to);
        if (channel) {
            const users = await this.ChatService.getUsersInChannel(data.to);
            console.log(...oo_oo(`271497111_291_6_291_66_4`, "########################################## 00"));
            console.log(...oo_oo(`271497111_292_6_292_24_4`, users));
            this.handling_joinRoom_group(data, users);
        }
        return "OK";
    }
    async allConversationsDm(client, data) {
        console.log(...oo_oo(`271497111_306_4_306_53_4`, "*************   allConversationsDm"));
        console.log(...oo_oo(`271497111_307_4_307_21_4`, data));
        const decoded = this.decodeCookie(client);
        const user = await this.UsersService.findById(decoded.id);
        const dms = await this.ChatService.getAllConversations(user.id_user);
        console.log(...oo_oo(`271497111_318_4_318_79_4`, `##################################### DMS of ${user.id_user}`));
        console.log(...oo_oo(`271497111_319_4_319_20_4`, dms));
        let recv;
        let send;
        let namerecv;
        let avatarrecv;
    ...
    async getAllMessages(client, data) {
        const decoded = this.decodeCookie(client);
        const user = await this.UsersService.findById(decoded.id);
        console.log(...oo_oo(`271497111_395_4_395_21_4`, data));
        if (user) {
            ...
            console.log(...oo_oo(`271497111_416_6_416_46_4`, "Error user does not exist"));
    }
    async getAllMessagesRoom(client, data) {
        ...
        if (user) {
            ...
            console.log(...oo_oo(`271497111_442_6_442_46_4`, "Error user does not exist"));
    }
    async leavingRoom(client, data) {
        console.log(...oo_oo(`271497111_448_4_448_54_4`, "********************** leaveChannel"));
        console.log(...oo_oo(`271497111_451_4_451_21_4`, data));
        const user = await this.UsersService.findById(data.user_id);
        if (user) {
            const leave = await this.ChatService.getLeavingRoom(data.user_id, data.channel_id);
            if (leave) {
                console.log(...oo_oo(`271497111_457_8_457_83_4`, "User with ${data.user_id} is leaving room with id ${data.id}"));
                return true;
            }
        }
        else
            console.log(...oo_oo(`271497111_462_6_462_46_4`, "Error user does not exist"));
    }
    async bannedUser(client, data) {
        console.log(...oo_oo(`271497111_468_4_468_29_4`, "bannedUser"));
        console.log(...oo_oo(`271497111_469_4_469_21_4`, data));
        ...
        if (client) {
            ...
            console.log(...oo_oo(`271497111_476_6_476_79_4`, `checking id of clients and user are ${id} --- ${data.from}`));
            if (user1) {
                if (user1.id_user == data.from) {
                    if (user1 && user2) {
                        ...
                        if (bannedUser) {
                            ...
                            console.log(...oo_oo(`271497111_484_14_484_63_4`, `banned user is ================== `));
                            console.log(...oo_oo(`271497111_485_14_485_37_4`, bannedUser));
                        }
                    }
                }
            }
            ...
            console.log(...oo_oo(`271497111_493_6_493_28_4`, "ERRROR "));
    }
    async kickUser(client, data) {
        console.log(...oo_oo(`271497111_513_4_513_51_4`, "kickUser ======================="));
        console.log(...oo_oo(`271497111_514_4_514_21_4`, data));
        console.log(...oo_oo(`271497111_515_4_515_66_4`, "###############################################"));
        const user1 = await this.UsersService.findById(data.from);
        const user2 = await this.UsersService.findById(data.to);
        if (client) {
            const id = Number(client.handshake.query.user_id);
            ...
            console.log(...oo_oo(`271497111_538_6_538_26_4`, "error"));
    }
    async muteUser(client, data) {
        console.log(...oo_oo(`271497111_543_4_543_93_4`, "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ MUUTE USER @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"));
        console.log(...oo_oo(`271497111_545_4_545_21_4`, data));
        const user1 = await this.UsersService.findById(data.from);
        const user2 = await this.UsersService.findById(data.to);
        if (client) {
            const id = Number(client.handshake.query.user_id);
            ...
            console.log(...oo_oo(`271497111_566_6_566_26_4`, "error"));
    }
    async unmuteUser(client, data) {
        console.log(...oo_oo(`271497111_572_4_572_95_4`, "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ UNMUUTE USER @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@"));
        console.log(...oo_oo(`271497111_574_4_574_21_4`, data));
        const user1 = await this.UsersService.findById(data.from);
        const user2 = await this.UsersService.findById(data.to);
        if (client) {
            const id = Number(client.handshake.query.user_id);
            ...
            console.log(...oo_oo(`271497111_595_6_595_26_4`, "error"));
    }
};
