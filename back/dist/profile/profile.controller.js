...
let ProfileController = class ProfileController {
    ...
    async Get_About(req, res) {
        ...
        console.log(...oo_oo(`1029123741_77_4_77_27_4`, user.About));
        return user.About;
    }
    async VsBoot(req, body) {
        console.log(...oo_oo(`1029123741_83_4_83_21_4`, body));
        ...
        let name = user.name;
        console.log(...oo_oo(`1029123741_93_4_93_52_4`, "game_played: " + user.games_played));
        if (body.won) {
            gameW++;
            await this.prisma.user.update({
                where: { id_user: decoded.id },
    ...
    async gameinfos(req, body) {
        ...
        if (decoded == null)
            return;
        console.log(...oo_oo(`1029123741_257_4_257_36_4`, "gameinfoos ", body));
        await this.prisma.user.update({
            where: { id_user: decoded.id },
            data: {
                homies: body.homies,
        ...
        if (body.homies == true && body.invited == true) {
            console.log(...oo_oo(`1029123741_268_6_268_30_4`, "hna 33333"));
    ...
    deletecookie(res) {
        ...
        console.log(...oo_oo(`1029123741_310_4_310_33_4`, "cookie deleted"));
    }
    async verify_Otp(body, req) {
        console.log(...oo_oo(`1029123741_315_4_315_32_4`, 'veriyyy ', body));
        try {
            const decoded = this.jwt.verify(req.cookies[this.config.get('cookie')]);
            await this.prisma.user.update({
                where: { id_user: decoded.id },
