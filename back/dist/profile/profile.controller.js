...
let ProfileController = class ProfileController {
    ...
    async Get_About(req, res) {
        ...
        console.log(...oo_oo(`396336170_75_4_75_27_4`, user.About));
        return user.About;
    }
    async VsBoot(req, body) {
        console.log(...oo_oo(`396336170_81_4_81_21_4`, body));
        ...
        let name = user.name;
        console.log(...oo_oo(`396336170_91_4_91_52_4`, "game_played: " + user.games_played));
        if (body.won) {
            gameW++;
            await this.prisma.user.update({
                where: { id_user: decoded.id },
    ...
    async gameinfos(req, body) {
        ...
        if (decoded == null)
            return;
        console.log(...oo_oo(`396336170_255_4_255_36_4`, "gameinfoos ", body));
        await this.prisma.user.update({
            where: { id_user: decoded.id },
            data: {
                homies: body.homies,
        ...
        if (body.homies == true && body.invited == true) {
            console.log(...oo_oo(`396336170_266_6_266_30_4`, "hna 33333"));
    ...
    deletecookie(res) {
        ...
        console.log(...oo_oo(`396336170_308_4_308_33_4`, "cookie deleted"));
    }
};
