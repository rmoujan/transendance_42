...
let AuthController = class AuthController {
    ...
    async Remove_friends(Body, req) {
        ...
        const decoded = this.jwt.verify(req.cookies['cookie']);
        console.log(...oo_oo(`828653496_2`, friendData));
